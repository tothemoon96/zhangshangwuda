...
public class LessonsFragmentSupport extends BaseSherlockFragment {
	...
	private static final int MENU_COURSESPHOTOTIDY=Menu.FIRST+8;
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) 
	{
		...
		menu.add(MENU_GROUP, MENU_COURSESPHOTOTIDY, MENU_COURSESPHOTOTIDY, getResources().getString(R.string.coursephototidy));
